...
/**
 * Tests for {@link JavaReadonlyFile}.
 * <p/>
 * <img src="doc-files/ReadonlyFileTestsUML.png" alt="ReadonlyFile Test Class Hierarchy"/>
 */
public class JavaReadonlyFileTest extends ConcreteReadonlyFileTestAbstract
    <JavaFileSystemType, JavaReadonlyFile, JavaFileDelegate> {

  protected JavaFileSystemType getFileSystemType() {
    return new JavaFileSystemType();
  }

  protected String getAbsolutePath(JavaFileDelegate delegate)
      throws IOException {
    return delegate.getAbsolutePath();
  }

  protected JavaFileDelegate getDelegate(String absolutePath)
      throws IOException {
    return new JavaFileDelegate(absolutePath);
  }

  protected JavaFileDelegate getDelegate(JavaFileDelegate parent, String name)
      throws IOException {
    return new JavaFileDelegate(parent, name);
  }
