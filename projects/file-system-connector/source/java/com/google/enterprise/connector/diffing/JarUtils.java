...
/**
 * This class is copied verbatim from com.google.enterprise.connector.common to
 * avoid having the diffing connector depend on the connector-manager jar.
 */
// TODO: remove this class when JarUtils has been moved to
// connector-util.jar in third_party.
public class JarUtils {
  ...
  /**
   * Retrieve the Implementation-Version string from the Jar file that contains
   * the specified Class.
   *
   * @param clazz a Class unique to the jar file we are looking for.
   * @return the version string from the Jar file or the empty string ("") if
   *         none found.
   */
