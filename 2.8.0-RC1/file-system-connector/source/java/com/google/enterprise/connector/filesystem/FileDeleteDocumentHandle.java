 ...
 *
 */
public class FileDeleteDocumentHandle implements DocumentHandle {
  static enum DeleteField {
    DOCUMENT_ID
  }
   ...
   */
  FileDeleteDocumentHandle(String documentId) {
    if (documentId == null) {
  ...
  private JSONObject getJson() {
    try {
      ...
      result.put(DeleteField.DOCUMENT_ID.name(), documentId);
      return result;
